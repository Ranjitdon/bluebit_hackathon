            ...
            <CardHeader className="relative">
              ...
              <div className="relative z-10 flex items-end space-x-4 pt-16">
                ...
                <div className="flex-1">
                  <CardTitle className="text-2xl font-bold">{form.watch("name")}</CardTitle>
              ...
              {isEditing ? (
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{form.watch("location") || "Not specified"}</p>
                      </div>
                    </div>
                  ...
                  <div className="pt-4">
                    ...
                    <p className="text-sm text-muted-foreground">{form.watch("bio")}</p>
                  </div>
                </div>
              )}
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="ml-auto text-xs text-muted-foreground">Jan 15, 2023</span>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="stories">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Stories you've created or contributed to</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    A fantasy adventure about a hidden kingdom beyond the mountains.
                  </p>
                  <div className="flex items-center justify-between mt-4">
                    <span className="text-xs text-muted-foreground">Created: May 20, 2023</span>
                ...
                <div className="p-4 border rounded-lg">
                  ...
                  <div className="flex items-center justify-between mt-4">
                    <span className="text-xs text-muted-foreground">Created: April 12, 2023</span>
                    <Button variant="outline" size="sm">View</Button>
                  </div>
                </div>
              </div>
